...
<div class="container" style="padding-bottom: 300px;">
	<h2 style=" width: 100%; border-bottom: 4px solid #61B9C2"><b>Keranjang</b></h2>
				...
				if($jml > 0){
					...
					<?php 
					 ...
					 ?>
						...
						<tr>
						<td colspan='7' class='text-center bg-warning'><h5><b>Keranjang kosong.</b></h5></td>
						</tr>
					...
					echo "<tr>
					<td colspan='7' class='text-center bg-danger'><h5><b>Silahkan login sebelum mulai berbelanja.</b></h5></td>
					</tr>";
				}
				?>
