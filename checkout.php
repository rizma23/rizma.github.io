...
<div class="container" style="padding-bottom: 200px">
	<h2 style=" width: 100%; border-bottom: 4px solid #61B9C2"><b>Checkout</b></h2>
	<div class="row">
		<div class="col-md-6">
	...
	<div class="col-md-6 bg-success">
		<h5>Pastikan pesanan sudah sesuai :)</h5>
	</div>
	</div>
	<br>
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nomor Telepon" name="tlp">
				</div>
			</div>
