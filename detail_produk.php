...
?>
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid #61B9C2"><b>Detail produk</b></h2>

	<div class="row">
		<div class="col-md-4">
			<div class="thumbnail">
				<img src="image/produk/sabun ekonomi.png" width="400">
			</div>
		</div>
			...
			<form action="proses/add.php" method="GET">
				...
				<table class="table table-striped">
					<tbody>
						<tr>
							<td><b>Nama</b></td>
							<td>Cairan Pencuci Piring Ekonomi</td>
						</tr>
						<tr>
							<td><b>Harga</b></td>
							<td>Rp.9000</td>
